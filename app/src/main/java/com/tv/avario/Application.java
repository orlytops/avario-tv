...
import com.tv.avario.core.BluetoothScanner;
import com.tv.avario.core.NotificationArray;
import com.tv.avario.core.StateArray;
import com.tv.avario.core.WorkerThread;
import com.tv.avario.exception.AvarioException;
import com.tv.avario.mqtt.MqttManager;
import com.tv.avario.util.RefStringUtil;
...
public class Application extends android.app.Application {
  ...
  public static void startWorker(Context context) {
    if (Application.workHandler != null && Application.worker != null &&
        Application.worker.getState() != Thread.State.TERMINATED) {
