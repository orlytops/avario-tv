...
/*
    ...
    if (PlatformUtil.isLollipopOrNewer()) {
      drawable = context
          .getResources()
          .getDrawable(
              R.drawable.ic__placeholder,
              context.getTheme()
          );
    } else {
      drawable = context
          .getResources()
          .getDrawable(com.tv.avario.R.drawable.ic__placeholder);
    }
*/
  ...
  public static String getAssetRoot(Context context, boolean isLan) {
    ...
    /*public static DrawableLoader toDrawable(Context context, int assetId, DrawableLoader
    .Callback callback, View image) {


        String[] urls = AssetUtil.toAbsoluteURLs(context, context.getResources().getStringArray
        (assetId));
        for (String url : urls) {
  ...
  public static Picasso picasso(Context context) {
    if (picasso == null) {
      ...
      if (verifier != null) { builder.hostnameVerifier(verifier); }
   ...
   */
  public static void loadImage(Context context, int assetId, DrawableLoader.Callback callback,
      View image) {

    String[] urls = AssetUtil.toAbsoluteURLs(context,
        context.getResources().getStringArray(assetId));
    for (String url : urls) {
      if (image instanceof ImageButton) {
        ImageButton imageView = (ImageButton) image;
        AssetUtil.picasso(context).load(url).into(imageView);
   ...
   * @param image    imageview where the url is being loaded
   */
  public static void loadImage(Context context, String[] urls, DrawableLoader.Callback callback,
      View image) {
    for (String url : urls) {
      if (image instanceof ImageButton) {
        ImageButton imageView = (ImageButton) image;
   ...
   */
  public static DrawableLoader toDrawable(Context context, int assetId,
      DrawableLoader.Callback callback) {
   ...
   */
  public static DrawableLoader toDrawable(Context context, String[] urls,
      DrawableLoader.Callback callback) {
    DrawableLoader task;
