 ...
 */
public class BlindAssetLoader extends AssetLoaderTask<Map<int[], Bitmap>> {
    public static final String TAG = "Avario/BlindAssetLoader";
    ...
    private BlindAssetLoader.Callback callback;

    public BlindAssetLoader(Context context, BlindAssetLoader.Callback callback) {
        super(context);
    ...
    private Map<int[], Bitmap> toStateMap(List<Bitmap> bitmaps) {
        ...
        if (bitmaps == null)
            ...
            mapping.put(BlindAssetLoader.stateDefault, bitmaps.get(0));
        else
            for (int index = 0; index < BlindAssetLoader.states.length; index++)
                mapping.put(BlindAssetLoader.states[index], bitmaps.get(index));
