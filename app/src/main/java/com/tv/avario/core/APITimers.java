...
public class APITimers {
  ...
  public static void invalidate(String timerId) {
    if (!APITimers.runnables.containsKey(timerId)) { return; }
  ...
  private static void forget(String timerId) {
    if (timerId == null || !APITimers.runnables.containsKey(timerId)) { return; }
  ...
  private static class ExpireRunnable implements Runnable {
    ...
    public void run() {
      ...
      if (this.entityIds == null) { builder.append("null"); } else {
