...
public class FCMIntentService extends IntentService {
    ...
    public static final String ACTION_DELETE = "com.avariohome.avario.ACTION_DELETE";
    public static final String ACTION_REFRESH = "com.avariohome.avario.ACTION_REFRESH";
